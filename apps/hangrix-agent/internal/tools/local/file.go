...
func (e editTool) Call(_ context.Context, raw json.RawMessage) (any, error) {
	...
	// ----- edit constraints -----
	// Validation runs after CRLF→LF normalisation so checks always use \n.
...
// of needle in original. Returns -1 if no match exists.
...
// qualifying occurrence falls within the region.
