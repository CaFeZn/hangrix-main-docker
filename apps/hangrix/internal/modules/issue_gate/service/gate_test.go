...
func (s *stubIssueStore) ListDescendants(_ context.Context, _ int64, _ []int64) ([]*issuedomain.Issue, error) {
	panic("not implemented")
}
func (s *stubIssueStore) LoadIndicators(_ context.Context, _ []int64, _ int64, _ string) (map[int64]issuedomain.IssueIndicators, error) {
	panic("not implemented")
}
...
func (s *stubIssueStore) CreateComment(context.Context, int64, int64, string, string, string, int, int64) (*issuedomain.Comment, error) {
	panic("not implemented")
}
func (s *stubIssueStore) CreateAgentComment(context.Context, int64, string, string, string, int, int64) (*issuedomain.Comment, error) {
	panic("not implemented")
}
