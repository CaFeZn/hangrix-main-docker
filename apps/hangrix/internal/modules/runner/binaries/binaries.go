...
//	…
//
// Today only linux/amd64 ships; the loader doesn't care how many
// variants are present — drop more `<name>_<goos>_<goarch>` files
// into payload/ and they'll be served too.
//
