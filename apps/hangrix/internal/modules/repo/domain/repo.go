...
var (
	...
	ErrVariableNameInvalid      = errors.New("Variable name must start with a letter or underscore and contain only letters, digits, and underscores")
	ErrVariableConflict         = errors.New("a variable with that name already exists")
	ErrVariableKindInvalid      = errors.New("Variable kind must be either plain or secret")
