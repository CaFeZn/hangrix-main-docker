...
const (
	...
	// TriggerSubIssueMerged fires on the parent issue when a child
	// issue is merged. Agents on the parent subscribe to this to
	// track sub-issue completion.
	TriggerSubIssueMerged Trigger = "sub_issue.merged"

	// TriggerSubIssueClosed fires on the parent issue when a child
	// issue is closed. Agents on the parent subscribe to this to
	// track sub-issue closure.
	TriggerSubIssueClosed Trigger = "sub_issue.closed"
	...
	// TriggerManual is the direct-invoke path used by platform
	// callers that target exactly one role and bypass the per-role
	// triggers map — session reset, admin smoke-tests, etc. Roles
	// do not declare this in agents.yml; the spawner skips
	// triggerMatches when CauseKind is CauseKindManual.
...
var validTriggers = map[Trigger]struct{}{
	...
	TriggerSubIssueMerged:        {},
	TriggerSubIssueClosed:        {},
	TriggerIssueReady:           {},
	TriggerPlanReview:           {},
	TriggerManual:               {},
}
